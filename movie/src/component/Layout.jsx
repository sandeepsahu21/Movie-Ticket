...
const Layout = () => {
  return (
    <div className="min-h-screen flex flex-col bg-[url('/bg.jpg')] bg-cover bg-center text-white">
      <header className="bg-black/60 backdrop-blur-md px-10 py-3 flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="px-9 py-2 w-74 rounded-4xl bg-gray-900/80 border border-gray-600  text-white"
          />
